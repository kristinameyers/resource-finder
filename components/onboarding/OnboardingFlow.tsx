...
export function OnboardingFlow({ onComplete }: OnboardingFlowProps) {
    ...
    return (
      <View style={styles.container}>
        <View style={styles.center}>
          <Image source={require('../../assets/images/new-211-logo.png')} style={styles.logo} resizeMode="contain" />
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <View style={styles.center}>
        <Image source={require('../../assets/images/new-211-logo.png')} style={styles.logoSmall} resizeMode="contain" />
        <Text style={styles.logoDesc}>Get connected. Get Help.</Text>
      </View>
